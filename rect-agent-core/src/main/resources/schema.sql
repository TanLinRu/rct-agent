...
CREATE INDEX IF NOT EXISTS idx_messages_turn_index ON chat_messages(session_id, turn_index);
...
CREATE INDEX IF NOT EXISTS idx_tool_executions_mcp_server ON tool_executions(mcp_server_name);
...
CREATE INDEX IF NOT EXISTS idx_profile_changes_field ON profile_changes(field_name);
...
CREATE INDEX IF NOT EXISTS idx_checkpoints_session_id ON conversation_checkpoints(session_id);
CREATE INDEX IF NOT EXISTS idx_checkpoints_message_id ON conversation_checkpoints(message_id);
