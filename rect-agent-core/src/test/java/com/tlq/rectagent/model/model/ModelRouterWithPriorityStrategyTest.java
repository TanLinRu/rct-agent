...
public class ModelRouterWithPriorityStrategyTest {
    ...
    public void selectsProviderWithHighestPriority() {
        ...
        p1.setName("p1"); p1.setEnabled(true); p1.setType("dashscope"); p1.setModel("m"); p1.setCostPerToken(0.5); p1.setPriority(5); p1.setMock(true);
        DashScopeProvider d1 = new DashScopeProvider(p1);

        ModelProviderConfig p2 = new ModelProviderConfig();
        p2.setName("p2"); p2.setEnabled(true); p2.setType("dashscope"); p2.setModel("m"); p2.setCostPerToken(0.2); p2.setPriority(1); p2.setMock(true);
        ...
        // The router should return some non-null response when a provider is selected
